        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    ...
                    @if (session('success_update_pelaporan'))
                    <script>
                        Swal.fire({
                            position: "center",
                            icon: "success",
                            title: "Berhasil!",
                            text: "Status Pelaporan Berhasil diUpdate!",
                            showConfirmButton: true,
                        });
                    </script>
                    @endif
                                    ...
                                    <div class="modal fade" id="modalEdit" tabindex="-1">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <form action="{{ route('UpdatePelaporan', $p->id) }}"
                                                    method="POST"
                                                    ...
                                                    <div class="modal-header">
                                                        <h5 class="modal-title">Update Pelaporan Kerusakan</h5>
