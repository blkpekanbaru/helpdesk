                                ...
                                <div class="card-body">
                                    <form action="{{route('updatePekerjaan',$proyek->id)}}" method="post">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" id="nama_proyek" name="nama_proyek" value="{{$proyek->nama_proyek}}" class="form-control">
                                        </div>
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="date" id="tgl_mulai" name="tgl_mulai" value="{{$proyek->tgl_mulai}}" class="form-control">
                                        </div>
                                        <div class="mb-3">
                                            <label for="deadline" class="mb-2">Deadline</label>
                                            <input type="date" id="deadline" name="deadline" value="{{$proyek->deadline}}" class="form-control">
                                        </div>
